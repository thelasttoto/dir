...
class SignRequest(_message.Message):
    __slots__ = ("agent", "provider")
    AGENT_FIELD_NUMBER: _ClassVar[int]
    PROVIDER_FIELD_NUMBER: _ClassVar[int]
    agent: _agent_pb2.Agent
    provider: SignRequestProvider
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., provider: _Optional[_Union[SignRequestProvider, _Mapping]] = ...) -> None: ...
...
class VerifyRequest(_message.Message):
    ...
    def __init__(self, agent: _Optional[_Union[_agent_pb2.Agent, _Mapping]] = ..., provider: _Optional[_Union[VerifyRequestProvider, _Mapping]] = ...) -> None: ...
