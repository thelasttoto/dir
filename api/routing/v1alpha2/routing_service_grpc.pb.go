...
const (
	RoutingService_Publish_FullMethodName   = "/routing.v1alpha2.RoutingService/Publish"
	RoutingService_Unpublish_FullMethodName = "/routing.v1alpha2.RoutingService/Unpublish"
	RoutingService_Search_FullMethodName    = "/routing.v1alpha2.RoutingService/Search"
	RoutingService_List_FullMethodName      = "/routing.v1alpha2.RoutingService/List"
)
...
var RoutingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "routing.v1alpha2.RoutingService",
	...
	Metadata: "routing/v1alpha2/routing_service.proto",
}
