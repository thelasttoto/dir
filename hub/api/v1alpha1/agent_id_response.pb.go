...
var file_saas_v1alpha1_agent_id_response_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x73, 0x74, 0x42, 0xc3, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x61, 0x61,
...
var (
	...
	file_saas_v1alpha1_agent_id_response_proto_rawDescData = file_saas_v1alpha1_agent_id_response_proto_rawDesc
)
...
func file_saas_v1alpha1_agent_id_response_proto_rawDescGZIP() []byte {
	file_saas_v1alpha1_agent_id_response_proto_rawDescOnce.Do(func() {
		file_saas_v1alpha1_agent_id_response_proto_rawDescData = protoimpl.X.CompressGZIP(file_saas_v1alpha1_agent_id_response_proto_rawDescData)
	})
...
var file_saas_v1alpha1_agent_id_response_proto_goTypes = []interface{}{
...
func file_saas_v1alpha1_agent_id_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_saas_v1alpha1_agent_id_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AgentIdentifierResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_saas_v1alpha1_agent_id_response_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_saas_v1alpha1_agent_id_response_proto_rawDesc = nil
